...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.authorizeRequests()
                ...
                .antMatchers("/api/v1/fresh-products/inboundorder").hasRole(UserRole.Name.REPRESENTATIVE)
                .antMatchers("/api/v1/fresh-products/order/**").hasRole(UserRole.Name.BUYER)
